...
function getStack(accent: string) {
  return [
    ...
    { label: "Animations",       value: "Framer Motion",         icon: Zap,    color: accent },
  ];
}
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 6 }}>
            <div style={{
              ...
              background: `linear-gradient(135deg, ${hexToRgba(accent, 0.22)}, ${hexToRgba(accent, 0.10)})`,
            ...
            <div>
              ...
              <p style={{ margin: "3px 0 0", fontSize: "0.8125rem", color: "#4A5580" }}>
                v0.6.0 — Windows Native · Linux Supported
              </p>
            </div>
          </div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", flexShrink: 0 }}>
                <button
                  ...
                  style={{
                    ...
                    background: hexToRgba(accent, 0.10), border: `1px solid ${hexToRgba(accent, 0.22)}`,
                    color: accent, fontSize: "0.8125rem", fontWeight: 600, transition: "all 130ms ease",
                  }}
                  onMouseEnter={e => { const b = e.currentTarget; b.style.background = hexToRgba(accent, 0.20); b.style.borderColor = hexToRgba(accent, 0.40); b.style.boxShadow = `0 0 14px ${hexToRgba(accent, 0.15)}`; }}
                  onMouseLeave={e => { const b = e.currentTarget; b.style.background = hexToRgba(accent, 0.10); b.style.borderColor = hexToRgba(accent, 0.22); b.style.boxShadow = "none"; }}
                >
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {getStack(accent).map(({ label, value, icon: Icon, color }) => (
          ...
          <div style={{
            ...
            <span style={{ fontSize: "0.75rem", color: "#2D3450" }}>GPL-3.0 License · Open Source · v0.6.0</span>
            <button
              onClick={() => openLink(GITHUB_URL)}
              style={{
              ...
              onMouseEnter={e => { const b = e.currentTarget; b.style.borderColor = hexToRgba(accent, 0.25); b.style.color = accent; }}
